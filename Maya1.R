...
print(krusGR)
krusW<-kruskal(beha$W, trt = beha$treatment, alpha= 0.01)
print(krusW)
krusF<-kruskal(beha$F, trt = beha$treatment, alpha= 0.01)
print(krusF)
krusPR<-kruskal(beha$PR , trt =  beha$treatment, alpha= 0.01)
print(krusPR)
krusN<-kruskal(beha$N, trt= beha$treatment, alpha= 0.01)
print(krusN)
