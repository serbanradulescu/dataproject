...
```{r HSD Test for weight, fig.cap="Figure a4.2. HSD test that studies the effect of treatment on weight for of Eristalis tenax larvae when reared in substrate contaminated with five different concentrations of thiamethoxam, plus control.", error=FALSE, echo=TRUE}
