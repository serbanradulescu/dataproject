...
We ran the prcomp command to run a PCA on our dataframe. From the Eigen values aand the Scree plot of our PCA we understand that Principal Component 1 and Principal Component 2 explain 46.4% of the variance in the data.
